...
HANDLER_METHODS: Mapping[str, str] = MappingProxyType(
    {
        ...
        "implementation.plan": "_implementation_action",
        "implementation.show": "_implementation_action",
        "implementation.apply": "_implementation_action",
        "implementation.status": "_implementation_action",
        "implementation.verify": "_implementation_action",
        "routing.enforcement": "_route_enforcement",
