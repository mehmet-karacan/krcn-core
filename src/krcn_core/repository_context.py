...
REQUIRED_CANONICAL_KEYS = {
    ...
    "outbound_assurance_boundary",
    "outbound_assurance_policy",
    "provider_assurance_profile_schema",
    "outbound_data_decision_schema",
    "secret_broker_ref_schema",
    "worktree_sandbox_boundary",
    "sandbox_host_profile_schema",
    "worktree_sandbox_plan_schema",
    "sandbox_patch_artifact_schema",
    "implementation_delivery_boundary",
    "implementation_plan_schema",
    "implementation_result_schema",
    "implementation_verification_schema",
    "route_enforcement_policy",
    "route_enforcement_policy_schema",
    "route_enforcement_decision_schema",
    "optional_team_runtime_boundary",
    "team_runtime_need_policy",
    "team_runtime_need_policy_schema",
    "team_runtime_assessment_schema",
    "local_record_schema",
    ...
    "agent_result_normalization_schema",
    "agent_result_fan_in_schema",
    "workflow_step_receipt_boundary",
    "workflow_step_receipt_schema",
    "workflow_step_receipt_aggregate_schema",
    ...
    "adaptive_routing_boundary",
    "adaptive_routing_policy",
    "adaptive_routing_policy_schema",
    "adaptive_routing_golden_set",
    ...
    "model_capability_policy_schema",
    ...
    "generic_dag_executor_boundary",
    "generic_dag_execution_plan_schema",
    "generic_dag_execution_result_schema",
    "work_index_boundary",
    "work_index_policy",
    "work_index_policy_schema",
    "work_index_plan_schema",
    "work_index_result_schema",
    ...
    "work_document_layout_migration_plan_schema",
