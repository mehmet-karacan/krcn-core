        ...
        smoke = subprocess.run(
            [
                ...
                (
                    ...
                    "required={'project.learn','project.integrate','project.index-source-code',"
                    "'project.search-source-code','project.rebind','portability.backup',"
                    ...
                    "from krcn_core.project_integration import prepare_project_integration; "
                    "from krcn_core.source_code_index import prepare_source_code_index; "
